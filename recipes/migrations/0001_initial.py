# Generated by Django 3.1.4 on 2021-03-31 16:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default='etvmh', verbose_name='слаг тэга')),
            ],
            options={
                'verbose_name': 'тэг',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='follower', to=settings.AUTH_USER_MODEL, verbose_name='последователь')),
            ],
            options={
